...
using SafeDeal.Activities;
using SafeDeal.Helpers;
using SafeDeal.Android.Models.Quizzes;
using SafeDeal.Widgets.Fab;
using SafeDeal.Android;

namespace SafeDeal.Widgets.Quizzes
{
	public abstract class AbsQuizView : FrameLayout
	{
		...
		protected AbsQuizView (Context context, Category category) : base (context)
		{
			...
			fastOutSlowInInterpolator = AnimationUtils.LoadInterpolator (Context, global::Android.Resource.Interpolator.FastOutSlowIn);
			linearOutSlowInInterpolator = AnimationUtils.LoadInterpolator (Context, global::Android.Resource.Interpolator.LinearOutSlowIn);
