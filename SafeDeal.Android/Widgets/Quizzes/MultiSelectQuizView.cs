...
namespace SafeDeal.Widgets.Quizzes
{
	public class MultiSelectQuizView : AbsQuizView<MultiSelectQuiz>
	{
		...
		protected override global::Android.Views.View CreateQuizContentView ()
		{
			listView = new ListView (Context) {
				Adapter = new OptionsQuizAdapter (Quiz.Options, global::Android.Resource.Layout.SimpleListItemMultipleChoice),
