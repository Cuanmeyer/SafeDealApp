...
using SafeDeal.Persistence;
using SafeDeal.Widgets.Quizzes;

namespace SafeDeal.Fragments
{
	public class QuizFragment : Fragment
	{
		...
		public override View OnCreateView (LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
		{
            ...
            return themedInflater.Inflate(Resource.Layout.ActivityListItem, container, false);
        }
