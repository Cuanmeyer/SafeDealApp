...
namespace SafeDeal.Android
{
    public class SlidingTabScrollView : HorizontalScrollView
    {
        ...
        public SlidingTabScrollView(Context context, IAttributeSet attrs, int defaultStyle) : base(context, attrs, defaultStyle)
        {
            ...
            FillViewport = true;
            this.SetBackgroundColor(global::Android.Graphics.Color.Rgb(0xE5, 0xE5, 0xE5)); //Gray color
        ...
        private void PopulateTabStrip()
        {
            ...
            for (int i = 0; i < adapter.Count; i++)
            {
                ...
                tabView.SetTextColor(global::Android.Graphics.Color.Black);
                tabView.Tag = i;
        ...
        private TextView CreateDefaultTabView(global::Android.Content.Context context)
        {
            TextView textView = new TextView(context);
            textView.Gravity = GravityFlags.Center;
            textView.SetTextSize(ComplexUnitType.Sp, TAB_VIEW_TEXT_SIZE_SP);
            textView.Typeface = global::Android.Graphics.Typeface.DefaultBold;

            if (Build.VERSION.SdkInt >= global::Android.OS.BuildVersionCodes.Honeycomb)
            {
                TypedValue outValue = new TypedValue();
                Context.Theme.ResolveAttribute(global::Android.Resource.Attribute.SelectableItemBackground, outValue, false);
                textView.SetBackgroundResource(outValue.ResourceId);
            }

            if (Build.VERSION.SdkInt >= global::Android.OS.BuildVersionCodes.IceCreamSandwich)
            {
